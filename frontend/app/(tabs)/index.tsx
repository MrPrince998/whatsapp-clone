        ...
        >
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => {
              if (item.icon)
                return (
                  <Pressable
                    ...
                    style={[
                      styles.tagContainer,
                      index === 0 && styles.tagContainerActive,
                    ]}
                  >
                    <UniversalIcon
                      library="feather"
              ...
              return (
                <Pressable
                  onPress={() => handleChangeTab(item.name as any)}
                  style={[
                    styles.tagContainer,
                    currentTag === item.name && styles.tagContainerActive,
                  ]}
                >
                  <Text
                    style={[
                      styles.tagText,
                      currentTag === item.name && styles.tagTextActive,
                    ]}
                  >
                    {item.name}
                  </Text>
